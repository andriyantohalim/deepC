...
{    
	...
	Tensor AAA = random_tensor(448,448, 3);
	
	Tensor kkk0 = random_tensor(7,7, 3);
	Tensor BBB = convolution_2d_Tsr_wCPU(&AAA, &kkk0, 3, 5);
	Tensor BBBo = Leaky_ReLU_Tsr_wCPU(&BBB);
	
	Tensor kkk1 = random_tensor(5,5, 5);
	...
	Tensor kkk2 = random_tensor(5,5, 5);
	...
	Tensor kkk3 = random_tensor(3,3, 4);
	...
	Tensor kkk4 = random_tensor(3,3, 4);
	...
	Tensor kkk5 = random_tensor(3,3, 5);
	...
	Tensor kkk6 = random_tensor(3,3, 5);
	...
	Tensor kkk7 = random_tensor(3,3, 10);
	...
	Matrix WW0 = random_matrix(600, I.len);
